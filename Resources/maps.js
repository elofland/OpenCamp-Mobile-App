...
// CREATE ANNOTATIONS
//
var hotelView = Titanium.Map.createAnnotation({
	latitude:32.9451400,
	longitude:-96.8400510,
	title:"Crowne Plaza Hotel Dallas",
	subtitle:'Addison, TX',
...
if (!isAndroid) {
	hotelView.pincolor = Titanium.Map.ANNOTATION_PURPLE;
} else {
	hotelView.pinImage = "../images/map-pin.png";
}
